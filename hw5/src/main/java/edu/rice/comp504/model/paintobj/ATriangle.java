...
public class ATriangle extends APaintObject {
     ...
     * */
    private ATriangle(Point loc, Point vel, String color, IUpdateStrategy strategy, int side){
        super(loc, vel, color, "Triangle", strategy);
        this.side = side;
    }
     ...
     * */
    public static ATriangle makeTriangle(IUpdateStrategy strategy, Point dims){
        ...
        // Return a new object
        return new ATriangle(loc, vel, "#EE48FF", strategy, side);
    }
